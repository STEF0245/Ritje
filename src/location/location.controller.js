 ...
 * @brief  Summary: Validates coordinates and proxies the geocoding response.
 * @details  Details: Parses request coordinates, delegates lookup to the location service, and returns provider metadata with normalized payloads.
 */

import { parseCoordinate, reverseGeocode } from './location.service.js'

/**
 * @brief  Summary: Reverse geocode the provided latitude and longitude.
 * @details  Details: Returns HTTP 404 when no address can be resolved, HTTP 400 for validation errors, and HTTP 502 for provider failures.
